...
namespace SafeArea {
  ...
  export function createComponent<T, R = never>(
    Cmp: any,
    propName = 'style',
    notStyleArray = false,
    ...
    return React.memo(
      forwardRef<any, T & SafeAreaCompsProps>(function (
        props: T & SafeAreaCompsProps,
        ref: React.Ref<R>,
      ) {
        ...
        return <Cmp ref={ref} {...props} {...defCmpProps} {...propStyle} />;
      } as any),
    );
  }

  export const View = createComponent<ViewProps>(ViewNative);
  export const ScrollView = createComponent<ScrollViewProps, ScrollViewBase>(
    ScrollViewBase,
